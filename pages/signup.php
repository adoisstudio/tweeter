...
<div class="container" align="center">
    ...
    <div id="wall" style="margin-top: 50px;">
        ...
        <div class="card bg-light border-secondary mb-3" align="center" style="max-width: 340px;">
            ...
            <div align="center" style="margin-top: 40px; max-width: 300px;">
                ...
                <input type="text" class="form-control" id="name" placeholder="Your Name" aria-label="Username"
                       aria-describedby="basic-addon1">

                <input type="text" class="form-control" id="city" placeholder="City" aria-label="Username"
                       aria-describedby="basic-addon1" style="margin-top: 10px;">

                <input type="text" class="form-control" id="user_name" placeholder="User name" aria-label="Username"
                       aria-describedby="basic-addon1" style="margin-top: 10px;">
                ...
                <button type="button" class="btn btn-outline-primary" style="margin-top: 15px;" onclick="signup();">
                    &nbsp;&nbsp;Sign Up&nbsp;&nbsp;
                </button>
                <br><br>
        ...
        http.onreadystatechange = function () {
            ...
            if (this.readyState == 4 && this.status == 200) {
                ...
                if (json.status == 1) {
                    ...
                    setCookie("session", "", 0);
                    alert("Signup Failed: " + json.msg);
                }
            }//if

        }//

        http.open("POST", "../api/signup.php", true);
